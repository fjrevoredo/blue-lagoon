...
|---|---|
| `crates/contracts/src/lib.rs` | `GovernedActionKind` (line 1386), `GovernedActionPayload` (line 1717) |
| `crates/harness/src/governed_actions.rs` | `execute_governed_action()` (line 531), `validate_capability_scope()` (line 2046), `CanonicalGovernedActionPayload` (line 3785) |
| `crates/harness/src/policy.rs` | `classify_governed_action_risk()` (line 171) |
| `crates/workers/src/main.rs` | `governed_action_schema_message()` (line 1601), `governed_action_kind_as_str()` (line 2242) |
